...
console.log(
  boxen("ProtonVPN Generator " + version, {
    padding: 1,
    margin: 1,
    borderStyle: "double",
  })
...
async function createAccount() {
  ...
  await console.log(
    chalk.bold(chalk.cyan("i ") + "Generating your account...")
  );
  ...
  await page_proton
    .waitForSelector(
      "body > div.app-root > main > main > div > div:nth-child(5) > div:nth-child(1) > div.flex-item-fluid-auto.pt1.pb1.flex.flex-column > button"
    )
    .then(() => {})
    .catch((e) => {
